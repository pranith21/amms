...
%>
    	...
    	<div id="dwellersDetails" class="formContainer">
    		<form id="UpdateDwellerDetails" name="UpdateDwellerDetails" method="post" action="./ServerAdapter">
				...
				<div class="col3">
					...
					<div class="fields">
						<input type="date" id="dateOfBirth" name="dateOfBirth" value="<%=StringUtil.getStringForForm(DateUtil.dateToString(dwellersMasterVO.getDateOfBirth(), DateFormat.MMM_dd_yyyy))%>" <%if(!editDwellerFlag) {%>readonly<%}%>/>
					</div>
				...
				<div class="col4">
					...
					<div class="fields">
						<input type="date" id="dateOfAnniversary" name="dateOfAnniversary" value="<%=StringUtil.getStringForForm(DateUtil.dateToString(dwellersMasterVO.getDateOfAnniversary(), DateFormat.MMM_dd_yyyy))%>" <%if(!editDwellerFlag) {%>readonly<%}%>/>
					</div>
    	...
    	<div id="financialDetails" class="formContainer">
        	<form id="lookupFlat" name="lookupFlat" method="post" action="./ServerAdapter">
        		...
        		<input name="block" type="hidden" value="<%=StringUtil.getStringForForm(flatDetailsVO.getFlatNumberPrefix1())%>" />
        		<input name="flatNumber" type="hidden" value="<%=StringUtil.getStringForForm(flatDetailsVO.getFlatNumber())%>" />
				<div class="formHeader">
