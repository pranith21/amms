...
public abstract class AbstractFileListener extends TimerTask {
   ...
   * 
   */
  public AbstractFileListener(String monitoredFileName) throws FileNotFoundException {
   ...
   * 
   */
  public AbstractFileListener(File monitoredFile) throws FileNotFoundException {
...
//    System.out.println("Monitored File: " + this.monitoredFile.getName()+"...");
