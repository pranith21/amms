...
public class DateUtil {
   ...
   * based on the format specified by <code>dateFormat</code>
   * 
   * @param date
   * @param dateFormat
   * @return String
  ...
  /**
   * Converts <code>String</code> object to <code>java.util.Date</code>
   * based on the format specified by <code>dateFormatStr</code>
   * 
   * @param dateStr
   * @param dateFormatStr
   ...
   * 
   */
  public static int daysBetweenDates(Date date1, Date date2,boolean datesInclusive) {
