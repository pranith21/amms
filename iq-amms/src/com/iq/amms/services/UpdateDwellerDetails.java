...
public class UpdateDwellerDetails extends BaseService {
	...
	private static final String ANNIVERSARY_DATE = "anniversaryDate";
	private static final String ANNIVERSARY_MONTH = "anniversaryMonth";
	...
	public void execute(HashMap<String, Object> input) throws Exception {
		...
		String dateOfBirth = input.get(BIRTH_MONTH).toString()+"-"+input.get(BIRTH_DATE).toString();
		String dateOfAnniversary = input.get(ANNIVERSARY_MONTH).toString()+"-"+input.get(ANNIVERSARY_DATE);
