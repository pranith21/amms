...
public class FlatsHelper extends BaseHelper {
	...
	private static final String UPDATE_FLAT_DETAILS =
			"UPDATE FLAT_MASTER SET FLAT_NUMBER_PREFIX_1=?,FLAT_NUMBER_PREFIX_2=?,FLAT_NUMBER=?," +
					"FLAT_NUMBER_SUFFIX_1=?,FLAT_NUMBER_SUFFIX_2=?,FLOOR_NUMBER=?,AREA_SQFT=?," +
					"CREATE_DATE=?,FLAT_STATUS=? WHERE FLAT_ID = ?";
	...
	public DwellersMasterVO getDwellerDetails(int flatId) throws DbException {
		DataSet dataSet =
	 ...
	 */
	 ...
	 private DwellersMasterVO getDwellersMasterVO(DataSet dataSet, int rowNum) {
		 ...
		 dwellersMasterVO.setDateOfBirth(dataSet.getStringValue(rowNum, 8) );
		 dwellersMasterVO.setDateOfAnniversary(dataSet.getStringValue(rowNum, 9) );
	 ...
	 * @throws DbException
	 */
	public int updateFlatDetails(FlatDetailsVO flatDetailsVO) throws DbException{
		 int i=0;
		 i = mySqlSession.executeUpdate(UPDATE_FLAT_DETAILS,flatDetailsVO.getFlatNumberPrefix1(),flatDetailsVO.
				 getFlatNumberPrefix2(),flatDetailsVO.getFlatNumber(),flatDetailsVO.getFlatNumberSuffix1(),
				 flatDetailsVO.getFlatNumberPrefix2(),flatDetailsVO.getFloorNumber(),flatDetailsVO.getAreaInSqft(),
				 flatDetailsVO.getCreateDate(),flatDetailsVO.getFlatStatus(),flatDetailsVO.getFlatId());
