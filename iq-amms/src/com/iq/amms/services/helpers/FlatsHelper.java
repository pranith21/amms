...
public class FlatsHelper extends BaseHelper {
  ...
  public FlatDetailsVO getFlatDetails(String flatId) throws Exception {
    DataSet dataSet =
  ...
  public DwellersMasterVO getDwellerDetails(String flatId) throws Exception {
    DataSet dataSet =
  ...
  private DwellersMasterVO getDwellersMasterVO(DataSet dataSet, int rowNum) {
    ...
    dwellersMasterVO.setGender(Gender.valueOf(dataSet.getStringValue(rowNum,
        7)));
    dwellersMasterVO.setDateOfBirth(StringUtil.isEmpty(dataSet
        .getStringValue(rowNum, 8)) ? new Date(Calendar.getInstance()
        .getTimeInMillis()) : new Date(dataSet.getStringValue(rowNum, 8)));
    dwellersMasterVO.setDateOfAnniversary(StringUtil.isEmpty(dataSet
        .getStringValue(rowNum, 9)) ? new Date(Calendar.getInstance()
        .getTimeInMillis()) : new Date(dataSet.getStringValue(rowNum, 9)));
