...
public class BillHelper extends BaseHelper {
  ...
  public void generateInvoices() throws Exception {
    ...
    for (FlatDetailsVO flatDetailsVO : flatDetailsVOList) {
      ...
      newFincDetailsVO.setPriorBalanceMonthThree(financialDetailsVO
          .getPriorBalanceMonthTwo());
      newFincDetailsVO.setPriorBalanceMonthFour(financialDetailsVO
          .getPriorBalanceMonthThree());
      newFincDetailsVO.setPriorBalanceMonthFive(financialDetailsVO
          .getPriorBalanceMonthFour());
      newFincDetailsVO.setPriorBalanceMonthSix(financialDetailsVO
          .getPriorBalanceMonthFive());
      newFincDetailsVO.setPriorBalanceMonthMore(financialDetailsVO
          .getPriorBalanceMonthSix()
    ...
    SystemHelper systemHelper = new SystemHelper();
    systemHelper.updateLastBillDate(new Date());
  }
   ...
   * 
   */
  public BillMasterVO getBillMaster(String flatId) throws DbException {
    DataSet dataSet =
  ...
  public void finalizeAll() throws DbException {
    ...
    ArrayList<FlatDetailsVO> flatDetailsVOList = flatsHelper.getAllFlats();
    for (FlatDetailsVO flatDetailsVO : flatDetailsVOList) {
      BillMasterVO billMasterVO = getBillMaster(StringUtil.getStringValue(flatDetailsVO.getFlatId()));
  ...
  public boolean isPrintReady() throws DbException {
    ...
    for (FlatDetailsVO flatDetailsVO : flatDetailsVOList) {
      ...
      BillMasterVO billMasterVO =
          billHelper.getBillMaster(StringUtil.getStringValue(flatDetailsVO
              .getFlatId()));
