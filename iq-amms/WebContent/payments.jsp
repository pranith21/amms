...
function paymentModeSelectChange(paymentModeSelect) {
	...
	if (selectedValue == '0') {
		...
		var numberContent = '<div class="labels"><label for="comments">Comments</label></div><div class="fields"><input type="text" name="comments" maxlength="150" required /></div>';
		document.getElementById('transNumber').innerHTML = numberContent;
				...
				<div class="col1">
	        		...
	        		<div class="fields">
		          		<select name="paymentModeSelect" onchange="paymentModeSelectChange(this);">
		            		...
		            		<option value="4">Error Rectification</option>
		          		</select>
	        		</div>
					<div id="chequeNumber">
