...
%>
    ...
    <div class="bodycontent">
      <div class="mainmenu">
        <ul>
          <li><a href="#" title="Deals with actions on the Community [Alt+C]" accesskey="C">Community</a></li>
          ...
          <li class="selected"><a href="#" title="Deals with actions on the Financils [Alt+F]" accesskey="F">Financials</a></li>
      ...
      <div class="submenu">
        <div class="submenuheader">Financials Submenu</div>
        <ul>
          <li class="selected"><a href="#" title="">View all Current Bills</a></li>
          <li><a href="#" title="Search for an Apartment [Alt+L]" accesskey="L">Lookup an Apartment</a></li>
          <li><a href="#" title="View or Edit details [Alt+V]" accesskey="V">View/Edit Details</a></li>
        </ul>
      </div>
      <div class="workarea">
        <div class="workareaheader">header</div>
        <div class="workareadescription">
        <!--QUICK TOOLS STARTS-->
