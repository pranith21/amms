...
<body>
    ...
    <div class="bodycontent">
		<div style="border: 1px solid #aaaaaa; background: #dddddd; clear: both; width: 60%; padding: 5px; text-align: left; color: red;">
			<b>Error Occurred</b>
		</div>
		<div style="border-bottom: 1px solid #aaaaaa; border-right: 1px solid #aaaaaa; border-left: 1px solid #aaaaaa; background: #eeeeee; clear: both; width: 60%; height: 50px; overflow: auto; padding: 5px; text-align: left; color: red;">
          <%=request.getAttribute("errorMessage")%>
		</div>
		<div style="border: 1px solid #aaaaaa; background: #dddddd; clear: both; width: 60%; padding: 5px; text-align: left; color: red;">
			<b>Stack Trace</b>
		</div>
		<div style="border-bottom: 1px solid #aaaaaa; border-right: 1px solid #aaaaaa; border-left: 1px solid #aaaaaa; background: #eeeeee; clear: both; width: 60%; height: 400px; overflow: auto; padding: 5px; text-align: left; color: red;">
